    ...
    <>
      ...
      {(isPlaying || isGameOver) && gameState && (
        <div className="min-h-screen bg-black text-white flex flex-col items-center p-4 md:p-8 select-none">
          ...
          {/* Battle Stage */}
          <div className="flex-1 w-full max-w-5xl relative flex flex-col md:flex-row justify-around items-center md:items-end gap-8 pb-3">
            {/* stage floor */}
            <div className="hidden md:block absolute bottom-0 left-0 right-0 h-2 rounded-full bg-gradient-to-r from-transparent via-cyan-700/80 to-transparent shadow-[0_0_12px_rgba(34,211,238,0.35)]" />
            <Fighter 
              side="left" 
